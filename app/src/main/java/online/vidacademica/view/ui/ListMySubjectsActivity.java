...
public class ListMySubjectsActivity extends AppCompatActivity {
    ...
    private void getSubjects() {
        SubjectDTO sub1 = new SubjectDTO("nome1", false,null, null);
        SubjectDTO sub2 = new SubjectDTO("nome2", false,null, null);
        SubjectDTO sub3 = new SubjectDTO("nome3", false,null, null);
